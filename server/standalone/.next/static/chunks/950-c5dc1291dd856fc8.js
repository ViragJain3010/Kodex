  ...
  [950],
  {
    ...
    1538: (e, r, o) => {
      ...
      var t = o(2265),
        ...
        s = t.forwardRef((e, r) => {
          ...
          return (0, l.jsx)(a, { ...n, ref: r, children: o });
        });
      s.displayName = 'Slot';
    ...
    6164: (e, r, o) => {
      ...
      let t = e => {
        ...
        m = e => ({ cache: u(e.cacheSize), parseClassName: b(e), ...t(e) }),
        g = /\s+/,
        h = (e, r) => {
      ...
      let K = (function (e, ...r) {
        ...
        let l = function (a) {
          return (
            (t = (o = m(r.reduce((e, r) => r(e), e()))).cache.get), (n = o.cache.set), (l = s), s(a)
          );
        };
        function s(e) {
          let r = t(e);
        ...
        return {
          ...
          theme: {
            ...
            gradientColorStopPositions: [W, O],
            inset: S(),
            margin: S(),
            opacity: U(),
            padding: I(),
          ...
          classGroups: {
            ...
            w: [{ w: ['auto', 'min', 'max', 'fit', 'svw', 'lvw', 'dvw', $, r] }],
            'min-w': [{ 'min-w': [$, r, 'min', 'max', 'fit'] }],
            'max-w': [
              { 'max-w': [$, r, 'none', 'full', 'min', 'max', 'fit', 'prose', { screen: [M] }, M] },
            ],
            h: [{ h: [$, r, 'auto', 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }],
            'min-h': [{ 'min-h': [$, r, 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }],
            'max-h': [{ 'max-h': [$, r, 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }],
            size: [{ size: [$, r, 'auto', 'min', 'max', 'fit'] }],
            'font-size': [{ text: ['base', M, O] }],
            ...
            'line-clamp': [{ 'line-clamp': ['none', P, R] }],
            leading: [{ leading: ['none', 'tight', 'snug', 'normal', 'relaxed', 'loose', A, $] }],
            ...
            'text-decoration-thickness': [{ decoration: ['auto', 'from-font', A, O] }],
            'underline-offset': [{ 'underline-offset': ['auto', A, $] }],
            ...
            'bg-image': [
              { bg: ['none', { 'gradient-to': ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, L] },
            ],
            'bg-color': [{ bg: [e] }],
            ...
            'outline-offset': [{ 'outline-offset': [A, $] }],
            'outline-w': [{ outline: [A, O] }],
            'outline-color': [{ outline: [e] }],
            'ring-w': [{ ring: F() }],
            'ring-w-inset': ['ring-inset'],
            'ring-color': [{ ring: [e] }],
            'ring-opacity': [{ 'ring-opacity': [h] }],
            'ring-offset-w': [{ 'ring-offset': [A, O] }],
            'ring-offset-color': [{ 'ring-offset': [e] }],
            shadow: [{ shadow: ['', 'inner', 'none', M, T] }],
