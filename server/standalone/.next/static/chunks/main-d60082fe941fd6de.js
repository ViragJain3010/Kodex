    ...
    8795: (e, t, r) => {
      ...
      function l(e) {
        ...
        let t = (0, a.default)(e),
          ...
          u = l >= 0 ? i.slice(0, l).join('\n') : r,
          c = Error(n);
        Object.assign(c, e), (c.stack = u);
        let d = o.default.captureOwnerStack();
        return d && !1 === u.endsWith(d) && ((u += d), (c.stack = u)), c;
      }
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, '__esModule', { value: !0 }),
        ...
        async change(e, t, r, n, o) {
          ...
          if (!H && this.onlyAHashChange(J) && !Z) {
            ...
            try {
              ...
              throw (
                ((0, l.default)(e) && e.cancelled && V.events.emit('routeChangeError', e, J, Q), e)
              );
            }
